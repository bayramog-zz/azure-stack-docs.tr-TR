...
|-----|-----|
|Sanal makine boyutu |[DS3](azure-stack-vm-sizes.md) veya SQL Server Enterprise edition için daha yüksek.<br><br>[DS2](azure-stack-vm-sizes.md) veya SQL Server Standard edition ve Web edition için daha yüksek.|
|Depolama |Destekleyen bir sanal makine ailesini kullanması [Premium depolama](azure-stack-acs-differences.md).|
...
Aşağıdaki performans açısından duyarlı uygulamalar için [sanal makine boyutları](azure-stack-vm-sizes.md) önerilir:
...
Veri diski aktarım hızı, sanal makine ailesi serisi benzersiz olarak göre belirlenir. Yapabilecekleriniz [bu makaleye başvurun](azure-stack-vm-sizes.md) ailesi serisi sanal makinenin veri disk aktarım hızı tanımlamak için.
