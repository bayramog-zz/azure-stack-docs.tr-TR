...
Azure Stack bulut operatörü, temel alınan Azure Stack altyapı ve Hizmetleri için bir kurtarma planı oluşturmak için sorumludur. Daha fazla bilgi için makaleyi okuyun [geri dönülemez veri kaybından kurtarma](../operator/azure-stack-backup-recover-data.md).
