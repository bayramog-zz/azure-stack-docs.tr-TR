...
| Node.js | 2.8.3 | NPM bağlantısı:<br><https://www.npmjs.com/package/azure-storage><br>(Çalıştırma: `npm install azure-storage@2.8.3`)<br> <br>GitHub sürümü:<br><https://github.com/Azure/azure-storage-node/releases/tag/v2.8.3> | Hizmet örneği bildirimi |
...
| PHP | 1.2.0 | GitHub sürümü:<br>Birçok<https://github.com/Azure/azure-storage-php/releases/tag/v1.2.0-common><br>Bun<https://github.com/Azure/azure-storage-php/releases/tag/v1.2.0-blob><br>Sıradaki<br><https://github.com/Azure/azure-storage-php/releases/tag/v1.1.1-queue><br>Tablosundan<https://github.com/Azure/azure-storage-php/releases/tag/v1.1.0-table><br> <br>Besteci aracılığıyla Install (daha fazla bilgi Için [aşağıdaki ayrıntılara bakın](#install-php-client-via-composer---current).) | Bağlantı dizesi kurulumu |
...
| Ruby | 1.0.1 | RubyGems paketi:<br>Birçok<br><https://rubygems.org/gems/azure-storage-common/versions/1.0.1><br>Bun<https://rubygems.org/gems/azure-storage-blob/versions/1.0.1><br>Sıradaki<https://rubygems.org/gems/azure-storage-queue/versions/1.0.1><br>Tablosundan<https://rubygems.org/gems/azure-storage-table/versions/1.0.1><br> <br>GitHub sürümü:<br>Birçok<https://github.com/Azure/azure-storage-ruby/releases/tag/v1.0.1-common><br>Bun<https://github.com/Azure/azure-storage-ruby/releases/tag/v1.0.1-blob><br>Sıradaki<https://github.com/Azure/azure-storage-ruby/releases/tag/v1.0.1-queue><br>Tablosundan<https://github.com/Azure/azure-storage-ruby/releases/tag/v1.0.1-table> | Bağlantı dizesi kurulumu |
...
| Node.js | 2.7.0 | NPM bağlantısı:<br><https://www.npmjs.com/package/azure-storage><br>(Çalıştırma: `npm install azure-storage@2.7.0`)<br> <br>GitHub sürümü:<br><https://github.com/Azure/azure-storage-node/releases/tag/v2.7.0> | Hizmet örneği bildirimi |
...
| PHP | 1.0.0 | GitHub sürümü:<br>Birçok<https://github.com/Azure/azure-storage-php/releases/tag/v1.0.0-common><br>Bun<https://github.com/Azure/azure-storage-php/releases/tag/v1.0.0-blob><br>Sıradaki<br><https://github.com/Azure/azure-storage-php/releases/tag/v1.0.0-queue><br>Tablosundan<https://github.com/Azure/azure-storage-php/releases/tag/v1.0.0-table><br> <br>Besteci aracılığıyla Install (aşağıdaki ayrıntılara bakın).) | Bağlantı dizesi kurulumu |
