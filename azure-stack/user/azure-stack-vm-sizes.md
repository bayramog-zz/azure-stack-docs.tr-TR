...
> [!NOTE]
> *Temel A* VM boyutları, Portal üzerinden [Sanal Makine Ölçek Kümeleri](../operator/azure-stack-compute-add-scalesets.md) (VMSS) oluşturmak için kullanımdan kaldırıldı. Bu boyutla bir VMSS oluşturmak için PowerShell veya bir şablon kullanın.

|Boyut-Size\Name |vCPU     |Hafıza | En fazla geçici disk boyutu | En yüksek işletim sistemi diski verimlilik: (ıOPS) | En yüksek geçici depolama aktarım hızı (ıOPS) | Maksimum veri diski verimlilik (ıOPS) | En fazla NIC |    
|-----------------|-----|---------|---------|-----|------|-----------|----|
...
|Boyut     |vCPU     |Bellek (GiB) | Geçici depolama (GiB)  | En yüksek işletim sistemi disk aktarım hızı (ıOPS) | En yüksek geçici depolama aktarım hızı (ıOPS) | Maksimum veri diski/aktarım hızı (ıOPS) | En fazla NIC |    
|----------------|--|------|----|----|----|-------|---------|
