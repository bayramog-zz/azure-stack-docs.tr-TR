...
> [!Note]  
> Azure Stack çalıştırma (Windows Server ve SQL) ve App Service dağıtımı için genel olarak uygun görüntülerle gereklidir. App Service belgelerini inceleyin [Azure Stack'te App Service ile çalışmaya başlamadan önce](../operator/azure-stack-app-service-before-you-get-started.md) Azure Stack operatörü bölümü.
...
Bir özel anahtar dosyası OpenSSL oluşturulur. Sertifikayı PFX dosyasına aktarmak için yer tutucuları değiştirerek aşağıdaki komutu çalıştırın.  *\<özel anahtar dosyası >* ve  *\<birleştirilmiş-sertifika-dosyası >* özel ile anahtar yolları ve birleştirdiğiniz sertifika dosyasının.
