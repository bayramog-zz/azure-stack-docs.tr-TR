...
| *OutputSeverity* | Çıkış günlük kaydı düzeyi. Değerler **varsayılan** veya **ayrıntılı**. Varsayılan önem derecesi düzeyleri, kritik uyarı veya hata içerir. Tüm önem düzeyleri - verbose, bilgi, uyarı, kritik veya hata ayrıntı içerir  | String |
