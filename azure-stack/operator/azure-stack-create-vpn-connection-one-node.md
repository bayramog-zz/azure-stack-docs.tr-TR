...
* İki sunucu ve diğer önkoşullar bölümünde anlatıldığı gibi ASDK donanım gereksinimlerini karşılayan [hızlı başlangıç: Azure Stack geliştirme Seti'ni değerlendirmek](../asdk/asdk-download.md).
...
> [!NOTE]
> Dağıttığınız her ASDK izleyin [dağıtım yönergeleri](../asdk/asdk-install.md). Bu makalede, ASDK ortamları adlandırılır **POC1** ve **POC2**.
