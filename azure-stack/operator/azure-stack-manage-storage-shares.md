...
- Kiracı kullanıcılar'blob depolama alanında Azure Stack ile nasıl çalıştığı hakkında daha fazla bilgi için bkz: [Azure Stack depolama hizmetleri](/azure-stack/user/azure-stack-storage-overview#azure-stack-storage-services).
